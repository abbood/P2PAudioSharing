...
-(id)getFromUserMediaItemCollection:(MPMediaItemCollection *)mediaItemCollection{    
    NSArray *items = [mediaItemCollection items];
    NSString *const title = [[items objectAtIndex:0] valueForProperty:MPMediaItemPropertyTitle];
